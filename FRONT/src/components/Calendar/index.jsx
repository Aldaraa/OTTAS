...
function Calendar({data, onChange, currentDate, cellRender, extraComponent, containerClass='', headerClass='', cellClass='', picker='month', withToolbar,...restProps}) {
  const [ viewMode, setViewMode ] = useState('calendar')
  const [ curDate, setCurDate ] = useState(currentDate ? dayjs(currentDate) : dayjs())
  ...
  return (
    <div 
      id='calendar' 
      className={twMerge(`w-full col-span-12 bg-white shadow-md`, containerClass) }
    >
    <div className='flex items-center gap-4 mb-2'>
      <div className={twMerge(`flex gap-4 justify-start`, headerClass)}>
