  ...
  const generateColumns = [
    {
      ...
      width: '150px', 
      cellRender: (e) => (
        <div className='flex items-center gap-3 group px-1 whitespace-pre-wrap'>
    ...
    },
    {
      ...
      // width: 140,
      cellRender: (e) => (
        <span className='text-[12px] px-1 whitespace-pre-wrap'>
          {e.value}
        </span>
      )
    },
  ...
  const historyCols = [
    {
      ...
      width: '150px', 
      cellRender: (e) => (
        <div className='flex items-center gap-3 group px-1 py-1 whitespace-pre-wrap'>
          <div id={`emp${e.data.Id}`} style={{fontSize: '12px'}} className='flex items-center gap-1'>
            {e.data.RoomOwner ? <i className="dx-icon-home text-green-500"></i> : <i className="dx-icon-home text-gray-400"></i>} 
            {e.data.Gender === 1 ? <FaMale className='text-blue-600'/> : <FaFemale className='text-pink-500'/>} 
            <span 
