...
function RoomAuditDetail() {
  ...
  const handleSearch = (values) => {
    ...
    axios({
      method: 'get',
      url: `tas/audit/roomaudit/${empId}/${dates.startDate}/${dates.endDate}`,
      responseType: 'blob',
    }).then((res) => {
      if(res.status === 200){
  ...
  return (
    <div className='bg-white p-4 rounded-ot '>
      ...
      <div className='text-lg font-bold mb-3 mt-5'>Room Audit</div>
      <Form 
      ...
      >
        ...
        <Form.Item className='mb-0'>
          <Button type='primary' htmlType='button' onClick={() => form.submit()} loading={loading}>Get</Button>
        </Form.Item>
      </Form>
      {/* <Table
        data={data}
...
export default RoomAuditDetail