...
import { Tabs, Form as AntForm, Input, DatePicker, Select, Row, Col, Button as AntButton, notification, InputNumber } from 'antd'
import { ErrorTabElement, FormItemRender, Button, Skeleton, Form } from 'components'
...
const firstCapitalLetter = new RegExp(/^[A-Z]{1}[a-zA-Z]$/)
...
function MoreData() {
  ...
  const personalFields = [
    ...
    },
    {
      ...
      className: 'col-span-12 lg:col-span-6 mb-0',
      rules: [
        {required: profileFields['Firstname']?.FieldRequired, message: `${profileFields['Firstname']?.Label} is required`},
        { pattern: firstCapitalLetter, message: 'First letter is required'},
      ],
    },
    {
    ...
    {
      type: 'component',
      component: <AntForm.Item className='col-span-12 lg:col-span-6 mb-0' label={'ADAccount'} key={'component-ADAccount'}>
        <Row gutter={8}>
          <Col span={12}>
            <AntForm.Item 
              name="ADAccount"
      ...
      component: <>
          {
            state.referData?.fieldsOfGroups?.map((item, i) => (
              <AntForm.Item name={item.Id} label={item.Description} className='col-span-12 lg:col-span-7 mb-0' key={`g-fields-${i}`}>
                <Select 
                  showSearch
                  allowClear
  ...
  const items = [
    {
      ...
      key: '0',
      forceRender: true,
      children: <div className='py-4 grid grid-cols-12 gap-x-5 gap-y-2' key={'t-item-0'}>
    ...
    },
    {
      ...
      key: '1',
      forceRender: true,
      children: <div className='py-4 grid grid-cols-12 gap-x-5 gap-y-2' key={'t-item-1'}>
    ...
    },
    {
      ...
      key: '2',
      forceRender: true,
      children: <div className='py-4 grid grid-cols-12 gap-x-5 gap-y-2' key={'t-item-2'}>
    ...
    },
    {
      ...
      key: '3',
      forceRender: true,
      children: <div className='py-4 grid grid-cols-12 gap-x-5 gap-y-2' key={'t-item-3'}>
    ...
    },
    {
      ...
      key: '4',
      forceRender: true,
      children: <div className='py-4 grid grid-cols-12 gap-x-5 gap-y-2' key={'t-item-4'}>
          ...
          <>
            ...
            >
              <Tabs
                ...
                rootClassName='relative z-10 bg-white'
