...
const title = 'De-Mobilisation Type'

function DeMobilisationType() {
  ...
  useEffect(() => {
    action.changeMenuKey('/tas/demobilisationtype')
    getData()
  },[])
  ...
  const getData = () => {
    ...
    axios({
      method: 'get',
      url: 'tas/requestdemobilisationtype'
    }).then((res) => {
      setData(res.data)
...
export default DeMobilisationType