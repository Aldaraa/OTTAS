...
function Admins({data, getData, departmentData}) {
  ...
  const setPrimary = () => {
    ...
    axios({
      method: 'put',
      url: `tas/department/setmainadmin?Id=${editData.Id}`,
    }).then(() => {
      getData()
  ...
  return (
    <div className='max-w-[800px]'>
      ...
      <Popup
        ...
        width={350}
      >
        <div className='text-center'>Are you sure you want to assign <span className='font-bold'>{editData?.FullName}</span> the main admin?</div>
        <div className='flex gap-5 mt-4 justify-center'>
