...
const title = 'Shift Status Color'

function ShiftStatusColor() {
  ...
  useEffect(() => {
    action.changeMenuKey('/tas/shiftstatuscolor')
    getData()
  },[])
  ...
  const columns = [
    {
      ...
      width: '50px',
      cellRender: (e) => (
        <div className={`w-[30px] h-[13px]`} style={{background: e.data.Code}}></div>
      )
    },
    // {
    //   label: 'Code',
...
export default ShiftStatusColor