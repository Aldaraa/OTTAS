import { DatePicker, Divider, Input, InputNumber, Segmented, Select, Space } from 'antd'
...
function ScheduleForm({templates, form, onChangeParameters, departments}) {
            ...
            ({getFieldValue}) => {
              return(
                <>
                  ...
                  {
                    getFieldValue('scheduleType') !== 'RunTime' &&
                    <Form.Item 
                      label='Ends on' 
                      name='EndDate' 
                      className='mb-2' 
                  ...
                  {
                    getFieldValue('scheduleType') === 'Daily' ?
                    <Form.Item 
