          ...
          <Accordion title='De-Mobilisation Details' className='border col-span-12'>
            <div className='flex flex-col gap-4 p-4'>
              <div className='flex items-center'> 
                <div className='w-[180px] text-xs'><span className='text-red-400'>*</span>Date of Completion :</div> 
                <Form.Item
                  name='completionDate' 
                  className='mb-0'
              ...
              <div className='flex items-center'> 
                <div className='w-[180px] text-xs'><span className='text-red-400'>*</span>De-Mobilisation Type :</div> 
                <Form.Item 
              ...
              <div className='flex items-center'>
                ...
                <Form.Item name='employerComment' className='mb-0'>
                  <Input.TextArea size='small' className='w-[500px]'/>
                </Form.Item>
              </div>
            </div>
          </Accordion>
