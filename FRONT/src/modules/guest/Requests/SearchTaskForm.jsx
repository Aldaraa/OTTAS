...
function SearchTaskForm({onFinish, form, containerClass=''}) {
  ...
  return (
    <>
      <div className={twMerge('rounded-ot bg-white p-5 mb-5 shadow-md', containerClass)}>
          ...
          initValues={cacheSearch ? 
            {
              ...
              EndDate: cacheSearch.model.EndDate ? dayjs(cacheSearch.model.EndDate) : null,
            } 
            : 
            {
        ...
        >
          <div className='col-span-12 flex gap-4 justify-end mt-5'>
        ...
        <Checkbox.Group style={{width:'100%'}} value={selectedFields} onChange={onCheckChange}>
          <div className='grid grid-cols-12 gap-x-5'>
            {filterFields.map((item, i) => (
              <div className='col-span-6' key={`check-box-${i}`}>
