...
import { Form as AntForm, AutoComplete, Checkbox, DatePicker, InputNumber } from 'antd'
  ...
  return (
    <>
      <Table
        ...
        containerClass='shadow-none border-gray-300'
        title={
          <div className='flex justify-end items-center py-2 gap-3 border-b'>
