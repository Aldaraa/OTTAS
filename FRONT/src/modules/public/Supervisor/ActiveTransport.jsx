...
function OTActiveTransportSchedule({onChangeView}) {
  ...
  return (
    <div>
      {/* <Button className='mb-3' onClick={() => onChangeView('teambookings')}>Back</Button> */}
      <div className='my-5'>
        <div className='text-lg font-bold mb-3'>Active Transport</div>
        <Form
          form={form}
          fields={searchFields}
          className='grid grid-cols-12 gap-x-5 max-w-[800px]'
          onFinish={getData}
        >
...
export default OTActiveTransportSchedule