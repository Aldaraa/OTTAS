...
import { Button, PeopleProfile } from 'components'
...
function ExistingBookingDetail() {
  ...
  const items = [
    {
      ...
      children: <ExistingTransport firstDate={firstDate} lastDate={lastDate}/>
    },
    {
      key: '2',
      label: `Room Occupancy Enquiry`,
      children: <RoomOccupancy firstDate={firstDate} lastDate={lastDate}/>
    },
  ];
  ...
  return (
    <div className='px-6 py-5 rounded-ot shadow-card bg-white'>
      <Button
        className='mb-3' 
        onClick={() => navigate('/request/existingbookings')} 
        icon={<LeftOutlined />}
      >
        Back
      </Button>
