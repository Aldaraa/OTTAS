...
import { Tabs, Form as AntForm, Input, DatePicker, Select, Row, Col, notification, InputNumber, Alert } from 'antd'
...
function ProfileForm({className, onSubmit, containerRef, form}) {
    ...
    },
    {
      ...
      component: <AntForm.Item className='col-span-12 lg:col-span-6 mb-0' label='AD Account' key={'component-ADAccount'}>
        <Row gutter={8}>
          ...
          <Col span={12}>
            <Button htmlType='button' onClick={handleCheckAccount}>Account Check</Button>
          </Col>
        </Row>
      </AntForm.Item>
    },
  ...
  const onSiteFields = [
    ...
    },
    {
      ...
      inputprops: {
        ...
        disabled: state.userProfileData?.PeopleTypeId ? true : false
      }
    },
    {
  ...
  const onFailed = (e) => {
    if(e){
      ...
      api.error({
        ...
        btn: false,
        closeIcon: false,
        description: 'Please fill in all required fields of profile information'
      });
