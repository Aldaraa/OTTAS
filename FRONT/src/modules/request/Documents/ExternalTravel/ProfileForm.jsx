import { CloseCircleTwoTone, SaveFilled, UploadOutlined } from '@ant-design/icons'
import { Tabs, Form as AntForm, Input, DatePicker, Select, Row, Col, Button as AntButton, notification, Upload } from 'antd'
...
function ProfileForm({form, className, refreshData, currentGroup, disabled}) {
  ...
  const groupFields = [
    ...
    {
      label: 'Workforce Kiosk Enrolment',
      name: 'workforce',
      className: 'col-span-12 lg:col-span-7 mb-0',
      type: 'select',
      inputprops: {
  ...
  const handleChangeFile = (e) => {
    ...
    axios({
      ...
      form.setFieldValue('passportRawImageFileAddressId', res.data.Id)
    }).catch((err) => {
