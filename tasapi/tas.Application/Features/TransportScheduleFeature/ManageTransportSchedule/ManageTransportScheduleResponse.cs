...
namespace tas.Application.Features.TransportScheduleFeature.ManageTransportSchedule
{
    ...
    public sealed record ManageTransportScheduleResponse : BasePaginationResponse<ManageTransportScheduleResult>
    {
    }

    public sealed class ManageTransportScheduleResult
    {
