...
{
    public sealed record GetRequestDocumentExternalTravelAddResponse
    {
        ...
        public GetRequestDocumentExternalTravelAddTravel TravelData { get; set; }

    }


  
    public record GetRequestDocumentExternalTravelAddTravel
    {
        public int Id { get; set; }
        ...
        public int? FirstScheduleSeatsCount { get; set; }
        public int? LastScheduleSeatsCount { get; set; }
