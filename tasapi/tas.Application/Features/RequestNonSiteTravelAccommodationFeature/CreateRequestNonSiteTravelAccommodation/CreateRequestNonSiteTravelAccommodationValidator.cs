...
{ 
    public sealed class CreateRequestNonSiteTravelAccommodationValidator : AbstractValidator<CreateRequestNonSiteTravelAccommodationRequest>
    {
        public CreateRequestNonSiteTravelAccommodationValidator()
        {
